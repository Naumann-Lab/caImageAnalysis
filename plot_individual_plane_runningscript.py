...
for plane in list(range(0, 1)):
    fish = 'danionella_fish11/plane_' + str(plane)#'danionella_20240322_fish3/plane_' + str(plane)
    ...
    if fishtype == 'workingfish_tail' or fishtype == 'tailtrackedfish':
        tail_byframe, tail_bout_df \
            = plot_individual_plane.analyze_tail(frametimes_df, stimulus_df, tail_df, 5, 0.3)
    ...
    # plot_individual_plane.plot_trace_loc(frametimes_df, stimulus_df, refImg, ysort_f, 'raw', ysort_rois, minbar = 0, maxbar = 300, byregion = False, tail_byframe = tail_byframe)
    ...
    # plot_individual_plane.plot_trace_loc(frametimes_df, stimulus_df, refImg, ysort_normf, 'norm F', ysort_rois, minbar = 0, maxbar = 1, byregion = False, tail_byframe = tail_byframe)
    ...
    #                                      region_ysort_rois, minbar=0, maxbar=1, byregion=True,
    #                                      tail_byframe=tail_byframe)
    # plt.savefig(img_save_path + '00_aaa.png')
    ...
    #打入冷宫
    # plot_individual_plane.plot_fr(frametimes_df, region_ysort_normf, "norm F", region_ysort_rois, 0, 4.8, 25, refImg)
    # plt.savefig(img_save_path + '72_fr.png')
    # plt.savefig(img_save_path + '72_fr.png')
