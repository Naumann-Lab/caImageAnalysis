...
for plane in list(range(1, 20)):#list(range(0, 19)):#range(13, 14):#
    fish = 'danionella_fish11/plane_' + str(plane)
    fishtype = 'workingfish_tail' #workingfish or workingfish_tail or tailtrackedfish
    example_folder = Path(r'/Volumes/WD_BLACK/20240411_DC_neurod1g6f_wholebrain_simplified/fish11_wholebrain/plane_' + str(plane))
    ...
    if fishtype =='tailtrackedfish':
        wf = TailTrackedFish(folder_path = example_folder,
                         ...
                         #midnight_noon='midnight', #dedicate for planes imaged 00:00-1:00AM
                         invert= False,
                         )
