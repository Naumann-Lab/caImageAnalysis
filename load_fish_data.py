...
for plane in list(range(10, 12)) + list(range(13, 23)):#range(13, 14):
    fish = 'danionella_fish6/plane_' + str(plane)
    example_folder = Path(r'/Volumes/WD_BLACK/20240411_DC_neurod1g6f_wholebrain_simplified/fish6_wholebrain/plane_' + str(plane))
    ...
    ysort_rois, ysort_f, region_ysort_rois, region_ysort_f, ysort_stim_dict_f, region_ysort_stim_dict_f, \
           ysort_booldf_f, region_ysort_booldf_f = sort_y(wf, 'raw')
    ysort_rois, ysort_normf, region_ysort_rois, region_ysort_normf, ysort_stim_dict_normf, region_ysort_stim_dict_normf, \
           ysort_booldf_baseline_normf, region_ysort_booldf_baseline_normf = sort_y(wf, 'norm_baseline')
    ysort_rois, ysort_normf, region_ysort_rois, region_ysort_normf, ysort_stim_dict_normf, region_ysort_stim_dict_normf, \
        ysort_booldf_cluster_normf, region_ysort_booldf_cluster_normf = sort_y(wf, 'norm_cluster')
    ysort_rois, ysort_zdiff, region_ysort_rois, region_ysort_zdiff, ysort_stim_dict_zdiff, region_ysort_stim_dict_zdiff, \
           ysort_booldf_corr_zdiff, region_ysort_booldf_corr_zdiff = sort_y(wf, 'zdiff_corr')
